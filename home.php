                ...
                <nav>
                    ...
                    <div class="menu">
                        <ul>
                            ...
                            <li>
                                <a   href="http://localhost/php_project/shop/shop.php">Shop</a>
                            </li>
                            <li>
                                <a   href="http://localhost/php_project/check_cart/cart2.php">Cart</a>
                            </li>
                            
                            <li>
                                <div class="dropdown">
                                    <a class="dropbtn" id="navicon" href="http://localhost/php_project/registration/sign up.php"><img src="icons8-test-account-80 (1).png" width="70%" height="70%"></a>
                                    <div class="dropdown-content">
                                        <a class="adrop" href="http://localhost/php_project/registration/sign up.php">Register</a>
                                        <a  class="adrop" href="http://localhost/php_project/registration/sign up.php">Login</a>
            ...
            <section class="hero">
                <div class="hero-inner">
                    ...
                    <div class="btns">
                        ...
                        <a href="../php_project/shop/shop.php">
